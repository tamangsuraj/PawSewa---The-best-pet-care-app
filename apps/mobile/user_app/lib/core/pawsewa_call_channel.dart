...
/// 1:1 Customer Care (owner or partner ↔ PawSewa care admin). Same channel if both IDs fixed.
...
/// Stable 1:1 channel for a marketplace thread (customer ↔ rider / seller / care).
