...
/// Map location pin: loads a **bundled** asset first (`assets/map/map_pin.png`), then falls back to
/// a local [CustomPaint] (no network URLs, no icon font dependency).
/// Replace `map_pin.png` with your design asset; alignment [Alignment.bottomCenter] on [Marker] keeps the tip on the coordinate.
...
/// Compact “you are here” marker (filled disc + ring) — canvas-only.
