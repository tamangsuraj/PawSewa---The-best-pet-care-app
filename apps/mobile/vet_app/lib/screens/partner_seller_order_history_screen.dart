...
/// Shop owner: orders assigned to this seller, current vs past.
class PartnerSellerOrderHistoryScreen extends StatefulWidget {
  const PartnerSellerOrderHistoryScreen({super.key});

  @override
  State<PartnerSellerOrderHistoryScreen> createState() =>
      _PartnerSellerOrderHistoryScreenState();
}

class _PartnerSellerOrderHistoryScreenState
    extends State<PartnerSellerOrderHistoryScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final resp = await _api.getSellerAssignedOrders();
  ...
  Widget build(BuildContext context) {
    ...
    return PartnerScaffold(
      title: 'Shop order history',
      subtitle: 'Current and past orders for your store',
      actions: [
        IconButton(
          onPressed: _load,
